...
//    private static final String filePath = "/Users/simon/Downloads/1.xlsx";
    ...
    public void read(String filePath, String sheetName, int sheetIndex, int curRow, List<String> cellList) {
        ...
        WorlOrderPriority worlOrderPriority = WorlOrderPriority.getWorlOrderPriority(cellList.get(9));
        ...
        WorkOrderStatus workOrderStatus = WorkOrderStatus.getWorkOrderStatus(cellList.get(14));
